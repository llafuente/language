...
function read_function_options(parameter) {
  while(test(function_options)) {
    parameter[eat(true)] = true;
  }
}
...
function read_parameter_without_type(param) {
  log("read_parameter_without_type");
