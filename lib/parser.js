...
function read_expression_conditional() {
  return read_ternary_expression(
    "conditional",
    [read_expression_logical_or, read_expression_logical_and, read_expression_bitwise_xor, read_expression_bitwise_and, read_expression_relational, read_expression_shift, read_expression_additive, read_expression_multiplicative, read_literal],
    ["?"],
...
function read_expression_logical_or() {
  return read_binary_expression("logical_or", ["||"], [read_expression_logical_and, read_expression_bitwise_xor, read_expression_bitwise_and, read_expression_relational, read_expression_shift, read_expression_additive, read_expression_multiplicative, read_literal]);
}
function read_expression_logical_and() {
  return read_binary_expression("logical_and", ["&&"], [read_expression_bitwise_or, read_expression_bitwise_xor, read_expression_bitwise_and, read_expression_relational, read_expression_shift, read_expression_additive, read_expression_multiplicative, read_literal]);
}
function read_expression_bitwise_or() {
  return read_binary_expression("bitwise_or", ["|"], [read_expression_bitwise_xor, read_expression_bitwise_and, read_expression_relational, read_expression_shift, read_expression_additive, read_expression_multiplicative, read_literal]);
}
function read_expression_bitwise_xor() {
  return read_binary_expression("bitwise_xor", ["^"], [read_expression_bitwise_and, read_expression_relational, read_expression_shift, read_expression_additive, read_expression_multiplicative, read_literal]);
}
function read_expression_bitwise_and() {
  return read_binary_expression("bitwise_and", ["&"], [read_expression_equality, read_expression_relational, read_expression_shift, read_expression_additive, read_expression_multiplicative, read_literal]);
}
function read_expression_equality() {
  return read_binary_expression("equality", ["==", "!="], [read_expression_relational, read_expression_shift, read_expression_additive, read_expression_multiplicative, read_literal]);
}
function read_expression_relational() {
  return read_binary_expression("expression", ["<=", ">=", "<", ">"], [read_expression_shift, read_expression_additive, read_expression_multiplicative, read_literal]);
}

function read_expression_shift() {
  return read_binary_expression("shift", ["<<", ">>>", ">>"], [read_expression_additive, read_literal]);
}

function read_expression_additive() {
  return read_binary_expression("additive", ["+", "-"], [read_expression_multiplicative, read_literal]);
}

function read_expression_multiplicative() {
  return read_binary_expression("multiplicative", ["*", "/", "%"], [read_expression_unary, read_literal]);
}
...
function read_binary_expression(name, operators, below) {
  ...
  do {
    ...
    // eos and is second+ iteration, or a full expresion is found on as left hand side.
    if (is_eos() && (!first || left.expression === true)) {
      leafs.push(left);
      break;
    }
    first = false;
    ...
    leafs.push(ast);
    verbose("is_puntuator(ctt)", is_puntuator());
  } while (!is_puntuator());
