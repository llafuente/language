...
function read_assignment_expression_full() {
  ...
  if (!accept(module.exports.assignment_operators)) {
    return error("expected assignament operator: " + enclose(module.exports.assignment_operators, "'"));
  }
...
function read_expression_unary_left() {
  ...
  if (!accept(module.exports.left_unary_operators)) {
    return error("expected unary operator: " + enclose(module.exports.left_unary_operators, "'"), true);
  }
...
function read_expression_unary_right() {
  ...
  if (!accept(module.exports.right_unary_operators)) {
    return lit;
