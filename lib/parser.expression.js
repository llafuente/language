...
function read_expression_call() {
  ...
  // TODO 728: read_many(read_arguments, read_index_access, read_property)
}
...
function read_property_access() {
  if (accept(".")) {
    ...
    return is_error(lit) ? "expected: literal": lit;
  }
...
function read_expression_new_with_arguments() {
  // TODO NewToken _W_ callee:MemberExpression _W_ args:Arguments
  return error("not implemented", true);
}
