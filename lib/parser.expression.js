...
function read_expression_function() {
  console.log("read_expression_function", state.ctt);
...
function is_expression(ast) {
  return ["assignment-expr","call-expr", "new-expr", "member-expr", "left-unary-expr",
  "right-unary-expr", "binary-expr", "ternary-expr"].indexOf(ast.type) !== -1;
