...
module.exports = {
    ...
    // TODO add: typeof
    left_unary_operators: ["++", "--", "+", "-", "~", "!", "@", "delete", "clone", "typeof"],
...
function read_cast_plus_expression() {
  return read_cast(read_assignment_expression);
}
...
function read_member_expression() {
  ...
  var expr = one_of([
    read_cast_plus_expression, // TODO experimental
